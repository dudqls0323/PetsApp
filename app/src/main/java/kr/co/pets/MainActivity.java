...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //시작함 체크박스의 체크가 되면   CompoundButton.OnCheckedChangeListener
        chkAgree.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {   //chkAgree가 setOnCheckedChangeListener이벤트 발생시킴
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {    //콜백함수
                //체크되면 위젯이 모두 보이도록 설정
